...
const CodeTransfer = ({
  ...
  return (
    <Modal show={open} onHide={() => onToggle(false)}>
      ...
      <Modal.Body>
        <center>
          ...
          <p style={{ marginTop: '16px' }}>[A modal fechará automaticamente em {seconds} segundos para simular a confirmação de leitura do QRCode]</p>
        </center>
      </Modal.Body>
      <Modal.Footer>
